...
function Skills() {
  ...
  const skills: Skill[] = [
    ...
    { name: 'Symfony', proficiency: 'Intermediate', proficiencyValue: 50 },
    { name: 'HTML', proficiency: 'Intermediate', proficiencyValue: 50 },
    {
    ...
    { name: 'TypeScript', proficiency: 'Beginner', proficiencyValue: 25 },
